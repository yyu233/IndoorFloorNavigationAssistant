...
#ifndef CPP_TANGO_EDGE_DETECTION_APPLICATION_H_
#define CPP_TANGO_EDGE_DETECTION_APPLICATION_H_
 ...
 */
    class EdgeDetectionApplication {
    public:
        ...
        int OnTouchEvent(float x, float y);
...
}  // namespace tango_edge-detection
